    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('INSIDE', 'Inside'), ('OUTSIDE', 'Outside'), ('THING', 'Thing'), ('MIXED', 'Mixed')], default='INSIDE', max_length=20)),
                ('default_image', models.ImageField(storage=xr_tour_guide_core.models.MinioStorage(), upload_to=xr_tour_guide_core.models.default_image_tour)),
                ...
                ('sub_tours', models.ManyToManyField(blank=True, null=True, related_name='parent_tours', to='xr_tour_guide_core.tour')),
