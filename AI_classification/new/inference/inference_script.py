...
# # ranking / consensus
# DIRECT_ACCEPT_THRESHOLD = 0.78
# DIRECT_ACCEPT_MARGIN = 0.14
# DIRECT_ACCEPT_MIN_VOTE_RATIO = 0.80
# TOP2_MAX_FOR_DIRECT_ACCEPT = 0.60

# SOFT_ACCEPT_THRESHOLD = 0.66
# SOFT_ACCEPT_MARGIN = 0.08
# SOFT_ACCEPT_MIN_VOTE_RATIO = 0.60
# SOFT_ACCEPT_TOP2_MAX = 0.62
...
def main():
    ...
    if direct_condition or soft_condition or geometry_rescue_condition:
